...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.upadte') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
                <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="submit" class="btn btn-success btn-md"><i class="far fa-save"></i> Save</button>
                </div>
            </div>
        </form>
    </div>
